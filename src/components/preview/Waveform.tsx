...
export function Waveform() {
  // Subscribe only to the path (a string), not to the whole VideoFile object,
  // so that unrelated file mutations (thumbnail / duration arriving) don't
  // re-run the effect and re-fetch the levels.
  ...
  return (
    <div className="card p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-zinc-500">
            Kırmızı çizgi mevcut threshold. Altta kalan bölgeler kesilir.
          </p>
        </div>
        {data && (
          <button
      ...
      <div className="mt-3 h-32 w-full overflow-hidden rounded-md bg-bg-elev p-1">
        {loading ? (
